            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Characteristic value</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Characteristic value</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Categories <a href="addnewcharacteristicvalue.php" style="float: right;">Add new</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                            <?php
                                                $url = 'characteristicvalueview.php?key=';
                                                $characteristicsvalue = R::findAll('characteristicvalue');
                                                foreach ($characteristicsvalue as $characteristicvalue) {
                                                $char = $characteristicvalue->characteristic;
                                                $characteristics  = R::findOne( 'characteristics', 'id = ?', ["$char"]); 
                                                echo '<tr><td>'. $characteristicvalue->id. '</td>'.
                                                '<td>'. $characteristicvalue->characteristicvalue.'</td>'.
                                                '<td>'. $characteristics->characteristic_name.'</td>'.
                                                '<td><a href="'.$url.$characteristicvalue->id.'">view</a>'.'</td></tr>';
                                                }
                                            ?>
                                    </tbody>
                                </table>
