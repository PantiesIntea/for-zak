                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Products <a href="addnewproducts.php" style="float: right;">Add new</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                            <?php
                                                ...
                                                <tr>
                                                    <td><?= $product->id ?></td>
                                                    <td><?= $product->productclass_name.' '.$product->productbrand_name.' '.$product->product_title ?></td>
                                                    <td><?= $product->price ?></td>
