                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Product brand <a href="addnewproductbrand.php" style="float: right;">Add new</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                            <?php
                                                $url = 'productbrandview.php?key=';
                                                $productbrand = R::findAll('productbrand');
                                                foreach ($productbrand as $productbrand) {
                                                $brand_count = $productbrand->id;
                                                echo '<tr><td>'. $productbrand->id. '</td>'.
                                                '<td>'. $productbrand->productbrand_name. ' (' . 
                                                $count = R::count('products', 'productbrand = ?', ["$brand_count"]) . ')</td>'.
                                                '<td><a href="'.$url.$productbrand->id.'">view</a>'.'</td></tr>';
                                                }
                                            ?>
                                    </tbody>
                                </table>
