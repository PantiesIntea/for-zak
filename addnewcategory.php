<?php
    ...
    if(isset($data['do_addnewcategory'])) {
        $errors = array();
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="./addnewcategory.php" method="POST">
                                    <div>
                                        <label>Name</label>
                                        <input name="category_name" class="dataTable-input" type="text">
                                    </div>
                                    <button name="do_addnewcategory" style="margin-top: 10px;" class="btn btn-primary">Create</button>
                                </form>
                            </div>
                        </div>
                        </div>
