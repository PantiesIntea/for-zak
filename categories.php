                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Categories <a href="addnewcategory.php" style="float: right;">Add new</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                            <?php
                                                $url = 'categoriesview.php?key=';
                                                $categories = R::findAll('categories');
                                                foreach ($categories as $category) {
                                                $cat_num = $category->id;
                                                echo '<tr><td>'. $category->id. '</td>'.
                                                '<td>'. $category->category_name. ' ('.
                                                $count = R::count('products', 'category = ?', ["$cat_num"]).
                                                ')</td>'.
                                                '<td><a href="'.$url.$category->id.'">view</a>'.'</td></tr>';
                                                }
                                            ?>
                                    </tbody>
                                </table>
