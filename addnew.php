                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="./addnew.php" method="POST">
                                    <div>
                                        <label>Email</label>
                                        <input name="email" class="dataTable-input" type="email">
                                    </div>
                                    <div>
                                        <label>Password</label>
                                        <input name="password" class="dataTable-input" type="text">
                                    </div>
                                    <button name="do_addnew" style="margin-top: 10px;" class="btn btn-primary">Create</button>
                                </form>
                            </div>
                        </div>
                        </div>
