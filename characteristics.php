            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Characteristics</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Characteristics</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                Categories <a href="addnewcharacteristics.php" style="float: right;">Add new</a>
                            </div>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                            <?php
                                                $url = 'characteristicsview.php?key=';
                                                $characteristics = R::findAll('characteristics');
                                                foreach ($characteristics as $characteristic) {
                                                echo '<tr><td>'. $characteristic->id. '</td>'.
                                                '<td>'. $characteristic->characteristic_name.'</td>'.
                                                '<td><a href="'.$url.$characteristic->id.'">view</a>'.'</td></tr>';
                                                }
                                            ?>
                                    </tbody>
                                </table>
