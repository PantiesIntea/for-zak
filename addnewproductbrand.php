<?php
    ...
    if(isset($data['do_addnewproductbrand'])) {
        $errors = array();
        if(trim($data['productbrand_name']) == '' ) {
            $errors[] = 'Введите имя!';
        }

        if (empty($errors)) {
        $productbrand = R::dispense('productbrand');
        $productbrand->productbrand_name = $data['productbrand_name'];

        R::store($productbrand);
                ...
                <main>
                    <div class="container-fluid px-6">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="./addnewproductbrand.php" method="POST">
                                    <div>
                                        <label>Name</label>
                                        <input name="productbrand_name" class="dataTable-input" type="text">
                                    </div>
                                    <button name="do_addnewproductbrand" style="margin-top: 10px;" class="btn btn-primary">Create</button>
                                </form>
                            </div>
                        </div>
                        </div>
